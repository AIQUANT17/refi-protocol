...
testAdmin = PubKeyHash (Builtins.toBuiltin (BS8.pack "admin"))

-- testPrePkh :: PubKeyHash
-- testPrePkh = PubKeyHash "pre_pkh"

testPrePkh :: PubKeyHash
testPrePkh = PubKeyHash (Builtins.toBuiltin (BS8.pack "pre_pkh"))

-- testPreSkh :: PubKeyHash
-- testPreSkh = PubKeyHash "pre_skh"

testPreSkh :: PubKeyHash
testPreSkh = PubKeyHash (Builtins.toBuiltin (BS8.pack "pre_skh"))

-- Default datum with scaled progress (5000 = 50.00%)
defaultDatum :: Validator.PlastiksDatum
defaultDatum =
  Validator.PlastiksDatum
...
tests =
  testGroup
    "Plastiks Validator Tests"
    [ testGroup
        "UpdateProgress Redeemer"
